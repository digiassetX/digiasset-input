...
describe('load first transfer', function() {
    it('load first transfer', function() {
        ...
        expect(input.getCount(50)).to.equal(50n);
        expect(input.getCID()).to.equal(undefined);
        expect(input.getAssetId(1n)).to.equal("Ua94nEKabzhJeDJtxGFXdviT185tYeHqyHKeWC");
        expect(input.getDecimals()).to.equal(2);
        let {assetId,amount,decimals}=input.getChange()[0];
        expect(assetId).to.equal("Ua94nEKabzhJeDJtxGFXdviT185tYeHqyHKeWC");
        expect(input.getCID()).to.equal(undefined);
        expect(amount).to.equal(99n);
